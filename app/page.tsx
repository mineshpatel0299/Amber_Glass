            ...
            <div className="flex-1 max-w-sm sm:max-w-sm md:max-w-md lg:max-w-2xl xl:max-w-4xl 2xl:max-w-4xl mt-32 sm:mt-20 md:mt-24 lg:mt-32 xl:mt-[150px] ml-1 px-4 sm:px-6 md:px-8 lg:px-0">
              ...
              >
                <div className="space-y-1 sm:space-y-2">
                  <h1
                    className={
                      "text-white uppercase text-4xl sm:text-2xl md:text-3xl lg:text-5xl xl:text-7xl 2xl:text-7xl flex flex-col justify-end items-end font-light tracking-tight leading-tigh" +
                      " " +
                      helvetica.className
                    }
                  >
